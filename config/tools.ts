...
export const tools: ToolConfig[] = [
  ...
  { id: 'style', name: 'Estilos e Filtros IA', description: 'Aplique estilos artísticos e filtros criativos à sua imagem, como Van Gogh, Anime, Cinemático, e mais.', icon: 'PaletteIcon', category: 'editing', isEditingTool: true },
  { id: 'trends', name: 'Trends', description: 'Explore os estilos de IA mais populares e do momento para transformar suas fotos com um clique.', icon: 'SparkleIcon', category: 'editing', isEditingTool: true, tag: 'new' },
