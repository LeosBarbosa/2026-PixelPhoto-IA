                                    ...
                                    {toolsForCategory.map(tool => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                disabled={isDisabled}
                                                className={`group w-full flex items-center gap-3 py-3 px-2 rounded-md text-left transition-colors duration-200 ease-in-out relative ${
                                                    isActive
                                                        ? `bg-gray-900/50 text-white font-semibold`
                                            ...
                                            >
                                                ...
                                                {isActive && (
                                                    <div className={`absolute left-0 top-1/4 h-1/2 w-1 rounded-r-full bg-blue-400`}></div>
                                                )}

                                                <div className={`ml-2 flex-shrink-0 w-8 h-8 flex items-center justify-center text-gray-400 transition-transform duration-200 ease-in-out group-hover:scale-110 ${isActive ? 'scale-105' : ''}`}>
                                                    <LazyIcon 
                                                        name={tool.icon} 
                                                        className={`w-6 h-6 transition-all duration-300 ${isActive ? 'text-blue-400' : `text-gray-400 group-hover:text-white`}`} 
                                                    />
                                                </div>
