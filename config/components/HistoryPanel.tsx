...
// FIX: Remove unused and undefined ImageLayer type. Use HistoryStateSnapshot.
import { type HistoryStateSnapshot } from '../../types';

const HistoryItem: React.FC<{ snapshot: HistoryStateSnapshot; index: number; isCurrent: boolean; onSelect: (index: number) => void; }> = React.memo(({ snapshot, index, isCurrent, onSelect }) => {
    // FIX: Use snapshot.file directly as the layer system was removed.
