...
const RemoveBgPanel: React.FC = () => {
    const { isLoading, handleRemoveBackground, currentState } = useEditor();
    // FIX: Defined isDisabled to fix reference error.
    const isDisabled = isLoading || !currentState?.file;
