...
// FIX: Rename LayerStateSnapshot to HistoryStateSnapshot to match exported type
import { type ToolId, type Workflow, type HistoryStateSnapshot, type ToolHistoryItem } from '../types';
...
export const saveHistory = async (history: HistoryStateSnapshot[], historyIndex: number, toolHistory: ToolHistoryItem[]): Promise<void> => {
